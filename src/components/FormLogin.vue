<template>
  <div class="max-w-xl mt-6 w-full m-auto">
    <form @submit="(e) => e.preventDefault()">
      <div class="grid w-full grid-cols-1 gap-5">
        <div
          class="input-group w-full focus-within:ring-2 dark:focus-within:ring-cyan-600 ring-slate-600 flex items-center space-x-2 bg-gray-200 dark:bg-slate-800 px-4 rounded-md"
        >
          <svg
